...
#### edits ---- allocate each call of - self.backward to free core 
## synchronize
...
class _SyntheticGradientUpdater(torch.autograd.Function):
    ...
    def backward(ctx, true_gradient):
        ...
        # print("DNI mean abs error: ",(synthetic_gradient.data-true_gradient.data).abs().mean())
